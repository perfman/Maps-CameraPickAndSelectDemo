package com.dev4u.camerapickandselectdemo.Camera;
...
import com.dev4u.camerapickandselectdemo.MainActivity;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private void showMedia() {
        ...
        while (iterator.hasNext()) {
            ...
            int wdpx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 300,
                    getResources().getDisplayMetrics());
            int htpx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 200,
                    getResources().getDisplayMetrics());
